...
//				.getContext(), R.raw.bg1);
	...
	public void playRandomSound() {
		if (soundsEnabled) {
			Random r = new Random();
			int sound = r.nextInt(14);
			soundPool.play(soundsMap.get(sound + 1), (float) 1.0, (float) 1.0,
					1, 0, 1);
		}
	}
	...
	public void playSound(int sound) {
		if (soundsEnabled) {
			switch (sound) {
			case 1:
				soundPool.play(soundsMap.get(SOUND_A), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 2:
				soundPool.play(soundsMap.get(SOUND_AA), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 3:
				soundPool.play(soundsMap.get(SOUND_C), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 4:
				soundPool.play(soundsMap.get(SOUND_CC), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 5:
				soundPool.play(soundsMap.get(SOUND_CCC), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 6:
				soundPool.play(soundsMap.get(SOUND_CCCC), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 7:
				soundPool.play(soundsMap.get(SOUND_D), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 8:
				soundPool.play(soundsMap.get(SOUND_DD), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 9:
				soundPool.play(soundsMap.get(SOUND_DDD), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 10:
				soundPool.play(soundsMap.get(SOUND_DDDD), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 11:
				soundPool.play(soundsMap.get(SOUND_F), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 12:
				soundPool.play(soundsMap.get(SOUND_FF), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 13:
				soundPool.play(soundsMap.get(SOUND_G), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			case 14:
				soundPool.play(soundsMap.get(SOUND_GG), (float) 1.0,
						(float) 1.0, 1, 0, 1);
				break;
			}
		}
